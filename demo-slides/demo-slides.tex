...
\begin{frame}{\insertsubsection}
    \begin{tabular}{ %tabular environment is used to create a table with two columns
		%
		%m comes from the array package and is used here to center the content of the box vertically
        @{} % no space on the left side of the table
        m{.48\linewidth} %control the width of the box it takes 48% of the width of the slide 
        @{\hspace{.04\linewidth}} %space between box and picture
        m{.47\linewidth} %control the width of the picture it takes 47% of the width of the slide
        @{}
		%48+4+47=99% of the width of the slide
    }
	%you can add minipage so you can control the sizes of this box
        ...
        \end{example}
        &
        \centering % this horizontally centers the image inside the right column.
        \pic[
			%you can edit the width and height of the picture to fit your needs
            width=.9\linewidth,
            height=0.75\textheight,
            keepaspectratio % this option will keep the aspect ratio of the picture
        ]{example-image}
    \end{tabular}
\end{frame}
\end{document}